...
const SUBJECTS = {
  ...
  history: {
    ...
    kw: {
      ...
      ru: ['история','исторический','революция','мировая война','империя','античность','средневековье','век','наполеон','колонизация','феодализм','монархия'],
      ...
      uk: ['історія','історичний','революція','світова війна','імперія','античність','середньовіччя','століття','колонізація','феодалізм','монархія'],
    }
  },
